            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center py-2">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/Institut Digital Ekonomi LPKIA Bandung.png') }}" class="h-10 w-auto object-contain py-1" alt="Logo LPKIA">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(auth()->user()->role === 'siswa')
                        ...
                        <x-nav-link :href="route('siswa.presensi.index')" :active="request()->routeIs('siswa.presensi.*')">
                            {{ __('📱 Presensi') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(auth()->user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.qr.index')" :active="request()->routeIs('admin.qr.*')">
                    {{ __('📱 QR Code Presensi') }}
                </x-responsive-nav-link>
